...
setup(
    ...
    install_requires=[
        ...
        'pydub',
        'setuptools',
        'websockets', # Because believe it or not, OpenAI agents use websockets and their package doesn't automatically install it
        'samplerate' # For resampling audio to and from OpenAI agents
    ],
    classifiers=[

...
class Config:
    ...
    AGI_SERVER_HOST = os.getenv('AGI_SERVER_HOST')
    """ The host of the asterisk AGI server. The hostname or IP address to which Asterisk should send AGI requests. The hostname or IP address your Python application is running on."""
